/********************************************************************************
** Form generated from reading UI file 'QtSerialCommunicator.ui'
**
...
#ifndef UI_QTSERIALCOMMUNICATOR_H
#define UI_QTSERIALCOMMUNICATOR_H
...
class Ui_QtSerialCommunicatorClass
{
public:
    ...
    void setupUi(QMainWindow *QtSerialCommunicatorClass)
    {
        if (QtSerialCommunicatorClass->objectName().isEmpty())
            QtSerialCommunicatorClass->setObjectName(QStringLiteral("QtSerialCommunicatorClass"));
        QtSerialCommunicatorClass->resize(623, 483);
        centralWidget = new QWidget(QtSerialCommunicatorClass);
        ...
        QtSerialCommunicatorClass->setCentralWidget(centralWidget);
        statusBar = new QStatusBar(QtSerialCommunicatorClass);
        statusBar->setObjectName(QStringLiteral("statusBar"));
        QtSerialCommunicatorClass->setStatusBar(statusBar);

        retranslateUi(QtSerialCommunicatorClass);

        tabCommunication->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(QtSerialCommunicatorClass);
    } // setupUi

    void retranslateUi(QMainWindow *QtSerialCommunicatorClass)
    {
        QtSerialCommunicatorClass->setWindowTitle(QApplication::translate("QtSerialCommunicatorClass", "QtSerialCommunicator", Q_NULLPTR));
        ButtonConnect->setText(QApplication::translate("QtSerialCommunicatorClass", "Connect", Q_NULLPTR));
        ButtonSend->setText(QApplication::translate("QtSerialCommunicatorClass", "Send", Q_NULLPTR));
        ButtonExport->setText(QApplication::translate("QtSerialCommunicatorClass", "Export", Q_NULLPTR));
        tabCommunication->setTabText(tabCommunication->indexOf(tab), QApplication::translate("QtSerialCommunicatorClass", "Communication", Q_NULLPTR));
        lblSettingDatabit->setText(QApplication::translate("QtSerialCommunicatorClass", "Databit", Q_NULLPTR));
        lblSettingStopbit->setText(QApplication::translate("QtSerialCommunicatorClass", "Stopbit", Q_NULLPTR));
        lblSettingParity->setText(QApplication::translate("QtSerialCommunicatorClass", "Parity", Q_NULLPTR));
        lblSettingBaud->setText(QApplication::translate("QtSerialCommunicatorClass", "Baud", Q_NULLPTR));
        lblSettingFlowcontrol->setText(QApplication::translate("QtSerialCommunicatorClass", "Flowcontrol", Q_NULLPTR));
        tabCommunication->setTabText(tabCommunication->indexOf(tabSettings), QApplication::translate("QtSerialCommunicatorClass", "Settings", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class QtSerialCommunicatorClass: public Ui_QtSerialCommunicatorClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_QTSERIALCOMMUNICATOR_H
